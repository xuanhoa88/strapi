...
module.exports = (scope, cb) => {
  ...
  if (_.isPlainObject(scope.args.attributes)) {
    ...
    scope.attributes = _.map(scope.args.attributes, (attribute) => {
    ...
    if (
      _(_.map(scope.attributes, (attribute) => attribute.name))
        .uniq()
  ...
  // Set connection
  scope.connection = _.get(scope.args, "connection", "default")
